    ...
    <div className="flex items-center gap-1">
        ...
        <DropdownMenu
          ...
          trigger={
            <button
              ...
              className="flex items-center gap-1 rounded-md px-1.5 py-1.5 text-left hover:bg-white/[0.06] disabled:opacity-50"
            >
      ...
      <DropdownMenu
        ...
        trigger={
          <button
            type="button"
            className="flex items-center gap-2 rounded-md px-2 py-1.5 text-left hover:bg-white/[0.06]"
          >
