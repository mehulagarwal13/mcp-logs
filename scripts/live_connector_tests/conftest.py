...
google_drive_spec = _require_connector("google_drive")
gitlab_spec = _require_connector("gitlab")
notion_spec = _require_connector("notion")
servicenow_spec = _require_connector("servicenow")
pagerduty_spec = _require_connector("pagerduty")
